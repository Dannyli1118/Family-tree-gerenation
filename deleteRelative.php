...
try {
    ...
    $checkCypher = "MATCH (n:Person {name: \$name, username: \$username}) RETURN count(n) as count";
    $checkResult = $client->run($checkCypher, [
        'name' => $name,
        'username' => $username
    ]);
    ...
    $deleteCypher = "MATCH (n:Person {name: \$name, username: \$username}) DETACH DELETE n";
    $client->run($deleteCypher, [
        'name' => $name,
        'username' => $username
    ]);
